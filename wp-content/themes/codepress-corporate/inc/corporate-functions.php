...
//var_dump($page_layout);
    ...
    $codepress_corporate_woo_layout = get_theme_mod( 'codepress_corporate_woocommerce_layout', 'left_content' );
    ...
    elseif( is_archive() ) {
      $codepress_corporate_archive_page_layout = get_theme_mod( 'codepress_corporate_archive_page_layout', 'left_content');
    ...
    elseif( is_single() ) {
     $codepress_corporate_single_post_layout = get_theme_mod( 'codepress_corporate_single_post_layout', 'left_content' );
    ...
    elseif( is_search() ) { 
    $codepress_corporate_search_page_layout = get_theme_mod( 'codepress_corporate_search_page_layout', 'left_content' );
