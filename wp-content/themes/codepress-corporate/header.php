...
<header role="banner" class="site-header <?php echo esc_attr($cc_logo_class); ?>" id="masthead"> 
		...
		$top_header = get_theme_mod( 'codepress_corporate_info_activate' );
		...
		?>
			...
			<div class="top-header">
				...
				<?php 
				$header_contact = get_theme_mod( 'codepress_corporate_top_contact_number' );
				$header_email = get_theme_mod( 'codepress_corporate_top_email' );
				...
				?>
					...
					<?php 
					if(get_theme_mod('codepress_corporate_social_link_activate') == 1) { 

						$fb_url = get_theme_mod( 'codepress_corporate_social_facebook' ); 
						$twitter_url = get_theme_mod( 'codepress_corporate_social_twitter' ); 
						$gplus_url = get_theme_mod( 'codepress_corporate_social_google_plus' ); 
						$insta_url = get_theme_mod( 'codepress_corporate_social_instagram' ); 
						$youtube_url =get_theme_mod( 'codepress_corporate_social_youtube' ); 
