...
<!-- Services-start --> 
	...
	<?php 
    	...
    	$services_title = get_option( 'codepress_corporate_services_title' );
    	$services_descriptpon = get_option( 'codepress_corporate_services_description' );
    	$services_category = get_option('codepress_corporate_services_dropdown_categories');
    	$services_char_count = absint(get_option( 'codepress_corporate_services_charecter_count' )); 
	...
	$CTA_title = get_theme_mod( 'codepress_corporate_call_to_action_title' );
	$CTA_content = get_theme_mod( 'codepress_corporate_call_to_action_content' );
	$CTA_read_more = get_theme_mod( 'codepress_corporate_call_to_action_read_more' );
	...
	$aboutUs_active = absint(get_theme_mod( 'codepress_corporate_about_us_activate' ));
	$aboutUs_title = get_theme_mod( 'codepress_corporate_about_us_title' );
	$aboutUs_page = get_theme_mod( 'codepress_corporate_about_us_page' );
	$aboutUs_read_more = get_theme_mod( 'codepress_corporate_cta_read_more' );
	...
	<?php endif; ?>
		...
		<?php 
			...
			$Portfolio_active = absint(get_theme_mod( 'codepress_corporate_portfolio_section_activate' ));
...
<!-- Testimonial-start -->
		...
		$testimonial_active = absint(get_theme_mod( 'codepress_corporate_testimonials_activate' ));
		$testimonial_background = get_theme_mod( 'codepress_corporate_testimonial_background_image' );
		$testimonial_title = get_theme_mod( 'codepress_corporate_testimonials_title' );
		...
		$client_active = absint(get_theme_mod( 'codepress_corporate_client_activate' ));
		$client_title = get_theme_mod( 'codepress_corporate_client_title' );
	...
	<?php 
	$blog_active = absint(get_theme_mod( 'codepress_corporate_blog_activate' ));
	$blog_title = get_theme_mod( 'codepress_corporate_blog_title' );

	$blog_read_more_url = get_theme_mod( 'codepress_corporate_blog_post_read_more_url' );
	$blog_view_all = get_theme_mod( 'codepress_corporate_blog_post_read_more' );
	$blog_char_count = get_theme_mod( 'codepress_corporate_blog_charecter_count' );
...
$google_map_active = get_theme_mod( 'codepress_corporate_google_map_activate' );
$google_map_active_in_home = get_theme_mod( 'codepress_corporate_google_map_activate_home' );
$google_map_google_frame = get_theme_mod( 'codepress_corporate_google_map_frame' );


$contact_form_avtive = get_theme_mod( 'codepress_corporate_contact_setting_activate' );
$contact_form_avtive_in_home = get_theme_mod( 'codepress_corporate_contact_setting_activate_home' );
$contact_form_title = get_theme_mod( 'codepress_corporate_contact_title' );
